% Determine the insole array position in the Vicon coordinate system
% using CoP and CoM during quiet standing
...
% Identify quiet-standing interval
com_f.x = com.x;
com_f.y = com.y;
com_f.z = com.z;
...
hold off; legend('com.y'); title('Select quiet-standing interval');
subplot(3,1,2); hold on;
plot(com_f.y);
plot(com_f.z);
plot(idxs_stable_standing,com_f.y(idxs_stable_standing),'ro');
hold off; legend('com.y','com.z'); title('Select quiet-standing interval');
