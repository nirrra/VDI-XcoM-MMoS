...
p3 = plot(seg.time, seg.bos.plantar_left, 'Color', line_colors(3,:), 'LineWidth', 1.5, 'LineStyle', '-.', 'DisplayName', 'BoS Left');
p4 = plot(seg.time, seg.bos.plantar_right, 'Color', line_colors(4,:), 'LineWidth', 1.5, 'LineStyle', '-.', 'DisplayName', 'BoS Right');
...
legend([p1, p2, p3, p4], 'Location', 'southoutside', 'FontSize', 9);
title('Mediolateral', 'FontWeight', 'normal', 'FontSize', 12, 'Color', [.2 .2 .2]);
...
p3 = plot(seg.time, seg.bos.plantar_front, 'Color', line_colors(3,:), 'LineWidth', 1.5, 'LineStyle', '-.', 'DisplayName', 'BoS front');
p4 = plot(seg.time, seg.bos.plantar_back, 'Color', line_colors(8,:), 'LineWidth', 1.5, 'LineStyle', '-.', 'DisplayName', 'Plantar BoS back');
p5 = plot(seg.time, seg.bos.back, 'Color', line_colors(4,:), 'LineWidth', 1.5, 'LineStyle', '-.', 'DisplayName', 'BoS back');
...
xline(seg.time(seg.idx.idx_p4), '-.', 'Color', [0.80 0.40 0.40], 'LineWidth', 1.5, 'Alpha', 0.7);
xline(seg.time(seg.idx.idx_end), '-.', 'Color', [0.80 0.40 0.40], 'LineWidth', 1.5, 'Alpha', 0.7);
legend([p1, p2, p3, p4, p5], 'Location', 'southoutside', 'FontSize', 9);
title('Anteroposterior ', 'FontWeight', 'normal', 'FontSize', 12, 'Color', [.2 .2 .2]);
...
sgtitle([num2str(seg.info.idx_file,'%02d'),'_',num2str(seg.info.idx_seg),'_CoM_XcoM'], 'FontSize', 16, 'FontWeight', 'bold', 'Interpreter', 'none');

print(f, ['./outputs/images com xcom/',num2str(seg.info.idx_file,'%02d'),'_',num2str(seg.info.idx_seg),'_CoM_XcoM.png'],'-dpng','-r300');
