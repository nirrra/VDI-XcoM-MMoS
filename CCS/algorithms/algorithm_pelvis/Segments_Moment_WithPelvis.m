%% 转动惯量与数据来源有关
%% state == L 表示单支撑相左腿着地，R 表示单支撑相右腿着地
% 关节矩的正负与关节的旋转：以jointMomentGlobal.Thigh_Left_distal.x为例，表示小腿对大腿质心的关节矩，因此正值时，大腿远端向前向上，膝关节屈曲

function [moment_reaction_couple_global_new,moment_reaction_couple_local_new,Segments_Length,moment_couple_global_new,moment_from_reaction_force_new] = Segments_Moment_WithPelvis(mass,sex,kinectstream,...
    segments_com_position,segments_force,r_all_segments,segments_W_L,segments_Alfa_L,...
    ground_couple_moment_global_Left,ground_couple_moment_global_Right)
%% 各体段测量参数
% 参考De leva：Lcs指CoM与体段【上方】端点的距离占比
if sex == 'M'
    Lcs.HeadNeck = 1;
    Lcs.Trunk = 0.4161;
    Lcs.Pelvis = 0.6115;
...
%% 局部坐标系下，各体段绕质心旋转所需的力偶矩，格式3*1
len_Alfa = length(segments_Alfa_L.HeadNeck);
for i=1:len_Alfa
    moment_couple_local.HeadNeck{i} = (mass * M.HeadNeck * Moment_of_Inertia.HeadNeck) * ...
    ...
    moment_couple_local.Trunk{i} =(mass * M.Trunk * Moment_of_Inertia.Trunk) * ...
    ...
    moment_couple_local.Pelvis{i} =(mass * M.Pelvis * Moment_of_Inertia.Pelvis) * ...
        [segments_Alfa_L.Pelvis{i}(3,2);segments_Alfa_L.Pelvis{i}(1,3);segments_Alfa_L.Pelvis{i}(2,1)]...
        + segments_W_L.Pelvis{i} * (mass * M.Pelvis * Moment_of_Inertia.Pelvis) * ...
        [segments_W_L.Pelvis{i}(3,2);segments_W_L.Pelvis{i}(1,3);segments_W_L.Pelvis{i}(2,1)];
    
    moment_couple_local.Upperarm_Left{i} = (mass * M.Upperarm * Moment_of_Inertia.Upperarm) * ...
    ...
    moment_couple_local.Upperarm_Right{i} = (mass * M.Upperarm * Moment_of_Inertia.Upperarm) * ...
    ...
    moment_couple_local.Forearm_Left{i} = (mass * M.Forearm * Moment_of_Inertia.Forearm) * ...
    ...
    moment_couple_local.Forearm_Right{i} = (mass * M.Forearm * Moment_of_Inertia.Forearm) * ...
    ...
    moment_couple_local.Hand_Left{i} = (mass * M.Hand * Moment_of_Inertia.Hand) * ...
    ...
    moment_couple_local.Hand_Right{i} = (mass * M.Hand * Moment_of_Inertia.Hand) * ...
    ...
    moment_couple_local.Thigh_Left{i} = (mass * M.Thigh * Moment_of_Inertia.Thigh) * ...
    ...
    moment_couple_local.Thigh_Right{i} = (mass * M.Thigh * Moment_of_Inertia.Thigh) * ...
    ...
    moment_couple_local.Shank_Left{i} = (mass * M.Shank * Moment_of_Inertia.Shank) * ...
    ...
    moment_couple_local.Shank_Right{i} =(mass * M.Shank * Moment_of_Inertia.Shank) * ...
    ...
    moment_couple_local.Foot_Left{i} = (mass * M.Foot * Moment_of_Inertia.Foot) * ...
    ...
    moment_couple_local.Foot_Right{i} = (mass * M.Foot * Moment_of_Inertia.Foot) * ...
...
%% 全局坐标系下，各体段绕质心旋转所需的力偶矩，格式3*1
len_Alfa = length(segments_Alfa_L.HeadNeck);
for i=1:len_Alfa
    moment_couple_global.HeadNeck{i} = r_all_segments.HeadNeck{i} * moment_couple_local.HeadNeck{i};
    
    moment_couple_global.Trunk{i} = r_all_segments.Trunk{i} * moment_couple_local.Trunk{i};

    moment_couple_global.Pelvis{i} = r_all_segments.Pelvis{i} * moment_couple_local.Pelvis{i};
    
    moment_couple_global.Upperarm_Left{i} = r_all_segments.Upperarm_Left{i} * moment_couple_local.Upperarm_Left{i};
    
    moment_couple_global.Upperarm_Right{i} = r_all_segments.Upperarm_Right{i} * moment_couple_local.Upperarm_Right{i};
    
    moment_couple_global.Forearm_Left{i} = r_all_segments.Forearm_Left{i} * moment_couple_local.Forearm_Left{i};
    
    moment_couple_global.Forearm_Right{i} = r_all_segments.Forearm_Right{i} * moment_couple_local.Forearm_Right{i};
    
    moment_couple_global.Hand_Left{i} = r_all_segments.Hand_Left{i} * moment_couple_local.Hand_Left{i};
    
    moment_couple_global.Hand_Right{i} = r_all_segments.Hand_Right{i} * moment_couple_local.Hand_Right{i};
    
    moment_couple_global.Thigh_Left{i} = r_all_segments.Thigh_Left{i} * moment_couple_local.Thigh_Left{i};
    
    moment_couple_global.Thigh_Right{i} = r_all_segments.Thigh_Right{i} * moment_couple_local.Thigh_Right{i};
    
    moment_couple_global.Shank_Left{i} = r_all_segments.Shank_Left{i} * moment_couple_local.Shank_Left{i};
    
    moment_couple_global.Shank_Right{i} = r_all_segments.Shank_Right{i} * moment_couple_local.Shank_Right{i};
    
    moment_couple_global.Foot_Left{i} = r_all_segments.Foot_Left{i} * moment_couple_local.Foot_Left{i};
    
    moment_couple_global.Foot_Right{i} = r_all_segments.Foot_Right{i} * moment_couple_local.Foot_Right{i};
...
for i=1:len_Alfa
    ...
    %%%%%% 足
    % 两端的力对足质心的力矩
    moment_from_reaction_force.Foot_Left{i} = cross(([kinectstream.ANKLE_LEFT.x(i),kinectstream.ANKLE_LEFT.y(i),0] -...
            [segments_com_position.Foot_Left.x(i),segments_com_position.Foot_Left.y(i),segments_com_position.Foot_Left.z(i)]),...
            [segments_force.reaction_force_Foot_Left_distal.x(i),segments_force.reaction_force_Foot_Left_distal.y(i),segments_force.reaction_force_Foot_Left_distal.z(i)])'...
            + cross(([kinectstream.ANKLE_LEFT.x(i),kinectstream.ANKLE_LEFT.y(i),kinectstream.ANKLE_LEFT.z(i)] -...
            [segments_com_position.Foot_Left.x(i),segments_com_position.Foot_Left.y(i),segments_com_position.Foot_Left.z(i)]),...
    ...
    % 足远端力偶矩，地面对足作用力偶矩
    moment_reaction_couple_global.Foot_Left_distal{i} = [ground_couple_moment_global_Left.x(i);ground_couple_moment_global_Left.y(i);ground_couple_moment_global_Left.z(i)];
    % 足近端力偶矩
    ...
    moment_from_reaction_force.Thigh_Left{i} = cross(([kinectstream.KNEE_LEFT.x(i),kinectstream.KNEE_LEFT.y(i),kinectstream.KNEE_LEFT.z(i)] -...
        ...
        [segments_com_position.Thigh_Left.x(i),segments_com_position.Thigh_Left.y(i),segments_com_position.Thigh_Left.z(i)]),...
        [0,0,segments_force.reaction_force_Thigh_Left_hip.z(i)])';
    % 大腿远端力偶矩
    ...
    %%%%%% 足
    % 两端的力对足质心的力矩
    moment_from_reaction_force.Foot_Right{i} = cross(([kinectstream.ANKLE_RIGHT.x(i),kinectstream.ANKLE_RIGHT.y(i),0] -...
            [segments_com_position.Foot_Right.x(i),segments_com_position.Foot_Right.y(i),segments_com_position.Foot_Right.z(i)]),...
            [segments_force.reaction_force_Foot_Right_distal.x(i),segments_force.reaction_force_Foot_Right_distal.y(i),segments_force.reaction_force_Foot_Right_distal.z(i)])'...
            + cross(([kinectstream.ANKLE_RIGHT.x(i),kinectstream.ANKLE_RIGHT.y(i),kinectstream.ANKLE_RIGHT.z(i)] -...
            [segments_com_position.Foot_Right.x(i),segments_com_position.Foot_Right.y(i),segments_com_position.Foot_Right.z(i)]),...
    ...
    % 足远端力偶矩，地面对足作用力偶矩
    moment_reaction_couple_global.Foot_Right_distal{i} = [ground_couple_moment_global_Right.x(i);ground_couple_moment_global_Right.y(i);ground_couple_moment_global_Right.z(i)];
    % 足近端力偶矩
    ...
    moment_from_reaction_force.Thigh_Right{i} = cross(([kinectstream.KNEE_RIGHT.x(i),kinectstream.KNEE_RIGHT.y(i),kinectstream.KNEE_RIGHT.z(i)] -...
        ...
        [segments_com_position.Thigh_Right.x(i),segments_com_position.Thigh_Right.y(i),segments_com_position.Thigh_Right.z(i)]),...
        [0,0,segments_force.reaction_force_Thigh_Right_hip.z(i)])';
    % 大腿远端力偶矩
    ...
    % 两端的力对骨盆的力矩
    moment_from_reaction_force.Pelvis{i} = cross(([kinectstream.HIP_LEFT.x(i),kinectstream.HIP_LEFT.y(i),kinectstream.HIP_LEFT.z(i)] -...
        [segments_com_position.Pelvis.x(i),segments_com_position.Pelvis.y(i),segments_com_position.Pelvis.z(i)]),...
        [segments_force.reaction_force_Pelvis_Lower_Left.x(i),segments_force.reaction_force_Pelvis_Lower_Left.y(i),segments_force.reaction_force_Pelvis_Lower_Left.z(i)])'...
        + cross(([kinectstream.HIP_RIGHT.x(i),kinectstream.HIP_RIGHT.y(i),kinectstream.HIP_RIGHT.z(i)] -...
        [segments_com_position.Pelvis.x(i),segments_com_position.Pelvis.y(i),segments_com_position.Pelvis.z(i)]),...
        [segments_force.reaction_force_Pelvis_Lower_Right.x(i),segments_force.reaction_force_Pelvis_Lower_Right.y(i),segments_force.reaction_force_Pelvis_Lower_Right.z(i)])'...
        + cross(([kinectstream.SPINE_NAVAL.x(i),kinectstream.SPINE_NAVAL.y(i),kinectstream.SPINE_NAVAL.z(i)] -...
        [segments_com_position.Pelvis.x(i),segments_com_position.Pelvis.y(i),segments_com_position.Pelvis.z(i)]),...
        [segments_force.reaction_force_Pelvis_Upper.x(i),segments_force.reaction_force_Pelvis_Upper.y(i),segments_force.reaction_force_Pelvis_Upper.z(i)])';
    
    % 骨盆下端力偶矩
    moment_reaction_couple_global.Pelvis_Lower_Left{i} = - moment_reaction_couple_global.Thigh_Left_proximal{i};
    moment_reaction_couple_global.Pelvis_Lower_Right{i} = - moment_reaction_couple_global.Thigh_Right_proximal{i};
    
    % 骨盆上端力偶矩
    moment_reaction_couple_global.Pelvis_Upper{i} = moment_couple_global.Pelvis{i} - moment_reaction_couple_global.Pelvis_Lower_Left{i} ...
        - moment_reaction_couple_global.Pelvis_Lower_Right{i} - moment_from_reaction_force.Pelvis{i};
    
    
    %% 躯干
    %各段力偶矩
    moment_reaction_couple_global.Trunk_Lower_proximal{i} = - moment_reaction_couple_global.Pelvis_Upper{i};
    ...
    %各端对躯干的力矩
    moment_from_reaction_force.Trunk{i} = cross(([kinectstream.SPINE_NAVAL.x(i),kinectstream.SPINE_NAVAL.y(i),kinectstream.SPINE_NAVAL.z(i)] -...
        [segments_com_position.Trunk.x(i),segments_com_position.Trunk.y(i),segments_com_position.Trunk.z(i)]),...
        [segments_force.reaction_force_Trunk_Lower_proximal.x(i),segments_force.reaction_force_Trunk_Lower_proximal.y(i),segments_force.reaction_force_Trunk_Lower_proximal.z(i)])'...
        + cross(([kinectstream.SHOULDER_LEFT.x(i),kinectstream.SHOULDER_LEFT.y(i),kinectstream.SHOULDER_LEFT.z(i)] -...
        [segments_com_position.Trunk.x(i),segments_com_position.Trunk.y(i),segments_com_position.Trunk.z(i)]),...
    ...
    moment_zero{i} = moment_reaction_couple_global.Trunk_Lower_proximal{i} +...
...
for i=1:len_Alfa
    ...
    %%%%%% 足
    % 足远端力偶矩，地面对足作用力偶矩
    moment_reaction_couple_local.Foot_Left_distal{i} = (r_all_segments.Foot_Left{i})' * moment_reaction_couple_global.Foot_Left_distal{i};
    % 足近端力偶矩
    moment_reaction_couple_local.Foot_Left_proximal{i} = (r_all_segments.Foot_Left{i})' * moment_reaction_couple_global.Foot_Left_proximal{i};
    
    
    %%%%%%小腿
    % 小腿远端力偶矩
    moment_reaction_couple_local.Shank_Left_distal{i} = (r_all_segments.Shank_Left{i})' * moment_reaction_couple_global.Shank_Left_distal{i};
    % 小腿近端力偶矩
    moment_reaction_couple_local.Shank_Left_proximal{i} = (r_all_segments.Shank_Left{i})' * moment_reaction_couple_global.Shank_Left_proximal{i};
    
    %%%%%%大腿
    % 大腿远端力偶矩
    moment_reaction_couple_local.Thigh_Left_distal{i} = (r_all_segments.Thigh_Left{i})' * moment_reaction_couple_global.Thigh_Left_distal{i};
    % 大腿近端力偶矩
    moment_reaction_couple_local.Thigh_Left_proximal{i} = (r_all_segments.Thigh_Left{i})' * moment_reaction_couple_global.Thigh_Left_proximal{i};
    
    %% 右下肢
    %%%%%% 足
    % 足远端力偶矩，地面对足作用力偶矩
    moment_reaction_couple_local.Foot_Right_distal{i} = (r_all_segments.Foot_Right{i})' * moment_reaction_couple_global.Foot_Right_distal{i};
    % 足近端力偶矩
    moment_reaction_couple_local.Foot_Right_proximal{i} = (r_all_segments.Foot_Right{i})' * moment_reaction_couple_global.Foot_Right_proximal{i};
    
    
    %%%%%%小腿
    % 小腿远端力偶矩
    moment_reaction_couple_local.Shank_Right_distal{i} = (r_all_segments.Shank_Right{i})' * moment_reaction_couple_global.Shank_Right_distal{i};
    % 小腿近端力偶矩
    moment_reaction_couple_local.Shank_Right_proximal{i} = (r_all_segments.Shank_Right{i})' * moment_reaction_couple_global.Shank_Right_proximal{i};
    
    %%%%%%大腿
    % 大腿远端力偶矩
    moment_reaction_couple_local.Thigh_Right_distal{i} = (r_all_segments.Thigh_Right{i})' * moment_reaction_couple_global.Thigh_Right_distal{i};
    % 大腿近端力偶矩
    moment_reaction_couple_local.Thigh_Right_proximal{i} = (r_all_segments.Thigh_Right{i})' * moment_reaction_couple_global.Thigh_Right_proximal{i};
    ...
    % 手掌近端力偶矩
    moment_reaction_couple_local.Hand_Left_proximal{i} = (r_all_segments.Hand_Left{i})' * moment_reaction_couple_global.Hand_Left_proximal{i};
    
    %%%%%%前臂
    % 前臂远端力偶矩
    moment_reaction_couple_local.Forearm_Left_distal{i} = (r_all_segments.Forearm_Left{i})' * moment_reaction_couple_global.Forearm_Left_distal{i};
    % 前臂近端力偶矩
    moment_reaction_couple_local.Forearm_Left_proximal{i} = (r_all_segments.Forearm_Left{i})' * moment_reaction_couple_global.Forearm_Left_proximal{i};
    
    %%%%%%上臂 
    % 上臂远端力偶矩
    moment_reaction_couple_local.Upperarm_Left_distal{i} = (r_all_segments.Upperarm_Left{i})' * moment_reaction_couple_global.Upperarm_Left_distal{i};
    % 上臂近端力偶矩
    moment_reaction_couple_local.Upperarm_Left_proximal{i} = (r_all_segments.Upperarm_Left{i})' * moment_reaction_couple_global.Upperarm_Left_proximal{i};
    ...
    % 手掌近端力偶矩
    moment_reaction_couple_local.Hand_Right_proximal{i} = (r_all_segments.Hand_Right{i})' * moment_reaction_couple_global.Hand_Right_proximal{i};
    
    %%%%%%前臂
    % 前臂远端力偶矩
    moment_reaction_couple_local.Forearm_Right_distal{i} = (r_all_segments.Forearm_Right{i})' * moment_reaction_couple_global.Forearm_Right_distal{i};
    % 前臂近端力偶矩
    moment_reaction_couple_local.Forearm_Right_proximal{i} = (r_all_segments.Forearm_Right{i})' * moment_reaction_couple_global.Forearm_Right_proximal{i};
    
    %%%%%%上臂
    % 上臂远端力偶矩
    moment_reaction_couple_local.Upperarm_Right_distal{i} = (r_all_segments.Upperarm_Right{i})' * moment_reaction_couple_global.Upperarm_Right_distal{i};
    % 上臂近端力偶矩
    moment_reaction_couple_local.Upperarm_Right_proximal{i} = (r_all_segments.Upperarm_Right{i})' * moment_reaction_couple_global.Upperarm_Right_proximal{i};
    ...
    % 头颈近端力偶矩
    moment_reaction_couple_local.HeadNeck_proximal{i} = (r_all_segments.HeadNeck{i})' * moment_reaction_couple_global.HeadNeck_proximal{i};
    
    %% 骨盆
    moment_reaction_couple_local.Pelvis_Lower_Left{i} = (r_all_segments.Pelvis{i})' * moment_reaction_couple_global.Pelvis_Lower_Left{i};
    moment_reaction_couple_local.Pelvis_Lower_Right{i} = (r_all_segments.Pelvis{i})' * moment_reaction_couple_global.Pelvis_Lower_Right{i};
    moment_reaction_couple_local.Pelvis_Upper{i} = (r_all_segments.Pelvis{i})' * moment_reaction_couple_global.Pelvis_Upper{i};

    %% 躯干
    %各段力偶矩
    moment_reaction_couple_local.Trunk_Lower_proximal{i} = (r_all_segments.Trunk{i})' * moment_reaction_couple_global.Trunk_Lower_proximal{i};
    moment_reaction_couple_local.Trunk_Upper_Left_diatal{i} = (r_all_segments.Trunk{i})' * moment_reaction_couple_global.Trunk_Upper_Left_diatal{i};
    moment_reaction_couple_local.Trunk_Upper_Right_diatal{i} = (r_all_segments.Trunk{i})' * moment_reaction_couple_global.Trunk_Upper_Right_diatal{i};
    moment_reaction_couple_local.Trunk_Upper_Middle_distal{i} = (r_all_segments.Trunk{i})' * moment_reaction_couple_global.Trunk_Upper_Middle_distal{i};   
end
