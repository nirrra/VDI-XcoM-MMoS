...
function [segments_com_position,segments_com_velocity,segments_com_acceleration] = Segments_Velocity_Acceleration_WithPelvis(kinectstream,sex,freq,copLeft,copRight)
fs_filter = 6;
fs_filter_vel_acc = 3;
...
%躯干
xcom_Trunk = (Lcs.Trunk * (kinectstream.SPINE_NAVAL.x - (kinectstream.SHOULDER_LEFT.x...
    +kinectstream.SHOULDER_RIGHT.x)/2)+ (kinectstream.SHOULDER_LEFT.x + kinectstream.SHOULDER_RIGHT.x)/2);
ycom_Trunk = (Lcs.Trunk * (kinectstream.SPINE_NAVAL.y - (kinectstream.SHOULDER_LEFT.y...
    +kinectstream.SHOULDER_RIGHT.y)/2)+ (kinectstream.SHOULDER_LEFT.y + kinectstream.SHOULDER_RIGHT.y)/2);
zcom_Trunk = (Lcs.Trunk * (kinectstream.SPINE_NAVAL.z - (kinectstream.SHOULDER_LEFT.z...
    +kinectstream.SHOULDER_RIGHT.z)/2)+ (kinectstream.SHOULDER_LEFT.z + kinectstream.SHOULDER_RIGHT.z)/2);

%骨盆
xcom_Pelvis = (Lcs.Trunk * ((kinectstream.HIP_LEFT.x + kinectstream.HIP_RIGHT.x)/2 - kinectstream.SPINE_NAVAL.x)+ kinectstream.SPINE_NAVAL.x);
ycom_Pelvis = (Lcs.Trunk * ((kinectstream.HIP_LEFT.y + kinectstream.HIP_RIGHT.y)/2 - kinectstream.SPINE_NAVAL.y)+ kinectstream.SPINE_NAVAL.y);
zcom_Pelvis = (Lcs.Trunk * ((kinectstream.HIP_LEFT.z + kinectstream.HIP_RIGHT.z)/2 - kinectstream.SPINE_NAVAL.z)+ kinectstream.SPINE_NAVAL.z);
...
[b_pos, a_pos] = butter(4, fs_filter/(fs/2));
filter_com = @(v) filtfilt(b_pos, a_pos, hampel(v, win));

segments = {'HeadNeck','Trunk','Pelvis',...
...
%% 求解各体段质心速度 加速度
[segments_com_HeadNeck_velocity.x,segments_com_HeadNeck_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_HeadNeck,freq,fs_filter_vel_acc);
[segments_com_HeadNeck_velocity.y,segments_com_HeadNeck_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_HeadNeck,freq,fs_filter_vel_acc);
[segments_com_HeadNeck_velocity.z,segments_com_HeadNeck_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_HeadNeck,freq,fs_filter_vel_acc);


[segments_com_Trunk_velocity.x,segments_com_Trunk_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Trunk,freq,fs_filter_vel_acc);
[segments_com_Trunk_velocity.y,segments_com_Trunk_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Trunk,freq,fs_filter_vel_acc);
[segments_com_Trunk_velocity.z,segments_com_Trunk_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Trunk,freq,fs_filter_vel_acc);

[segments_com_Pelvis_velocity.x,segments_com_Pelvis_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Pelvis,freq,fs_filter_vel_acc);
[segments_com_Pelvis_velocity.y,segments_com_Pelvis_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Pelvis,freq,fs_filter_vel_acc);
[segments_com_Pelvis_velocity.z,segments_com_Pelvis_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Pelvis,freq,fs_filter_vel_acc);

[segments_com_Upperarm_Left_velocity.x,segments_com_Upperarm_Left_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Upperarm_Left,freq,fs_filter_vel_acc);
[segments_com_Upperarm_Left_velocity.y,segments_com_Upperarm_Left_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Upperarm_Left,freq,fs_filter_vel_acc);
[segments_com_Upperarm_Left_velocity.z,segments_com_Upperarm_Left_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Upperarm_Left,freq,fs_filter_vel_acc);


[segments_com_Upperarm_Right_velocity.x,segments_com_Upperarm_Right_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Upperarm_Right,freq,fs_filter_vel_acc);
[segments_com_Upperarm_Right_velocity.y,segments_com_Upperarm_Right_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Upperarm_Right,freq,fs_filter_vel_acc);
[segments_com_Upperarm_Right_velocity.z,segments_com_Upperarm_Right_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Upperarm_Right,freq,fs_filter_vel_acc);



[segments_com_Forearm_Left_velocity.x,segments_com_Forearm_Left_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Forearm_Left,freq,fs_filter_vel_acc);
[segments_com_Forearm_Left_velocity.y,segments_com_Forearm_Left_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Forearm_Left,freq,fs_filter_vel_acc);
[segments_com_Forearm_Left_velocity.z,segments_com_Forearm_Left_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Forearm_Left,freq,fs_filter_vel_acc);




[segments_com_Forearm_Right_velocity.x,segments_com_Forearm_Right_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Forearm_Right,freq,fs_filter_vel_acc);
[segments_com_Forearm_Right_velocity.y,segments_com_Forearm_Right_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Forearm_Right,freq,fs_filter_vel_acc);
[segments_com_Forearm_Right_velocity.z,segments_com_Forearm_Right_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Forearm_Right,freq,fs_filter_vel_acc);



[segments_com_Hand_Left_velocity.x,segments_com_Hand_Left_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Hand_Left,freq,fs_filter_vel_acc);
[segments_com_Hand_Left_velocity.y,segments_com_Hand_Left_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Hand_Left,freq,fs_filter_vel_acc);
[segments_com_Hand_Left_velocity.z,segments_com_Hand_Left_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Hand_Left,freq,fs_filter_vel_acc);



[segments_com_Hand_Right_velocity.x,segments_com_Hand_Right_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Hand_Right,freq,fs_filter_vel_acc);
[segments_com_Hand_Right_velocity.y,segments_com_Hand_Right_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Hand_Right,freq,fs_filter_vel_acc);
[segments_com_Hand_Right_velocity.z,segments_com_Hand_Right_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Hand_Right,freq,fs_filter_vel_acc);



[segments_com_Thigh_Left_velocity.x,segments_com_Thigh_Left_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Thigh_Left,freq,fs_filter_vel_acc);
[segments_com_Thigh_Left_velocity.y,segments_com_Thigh_Left_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Thigh_Left,freq,fs_filter_vel_acc);
[segments_com_Thigh_Left_velocity.z,segments_com_Thigh_Left_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Thigh_Left,freq,fs_filter_vel_acc);


[segments_com_Thigh_Right_velocity.x,segments_com_Thigh_Right_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Thigh_Right,freq,fs_filter_vel_acc);
[segments_com_Thigh_Right_velocity.y,segments_com_Thigh_Right_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Thigh_Right,freq,fs_filter_vel_acc);
[segments_com_Thigh_Right_velocity.z,segments_com_Thigh_Right_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Thigh_Right,freq,fs_filter_vel_acc);



[segments_com_Shank_Left_velocity.x,segments_com_Shank_Left_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Shank_Left,freq,fs_filter_vel_acc);
[segments_com_Shank_Left_velocity.y,segments_com_Shank_Left_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Shank_Left,freq,fs_filter_vel_acc);
[segments_com_Shank_Left_velocity.z,segments_com_Shank_Left_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Shank_Left,freq,fs_filter_vel_acc);


[segments_com_Shank_Right_velocity.x,segments_com_Shank_Right_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Shank_Right,freq,fs_filter_vel_acc);
[segments_com_Shank_Right_velocity.y,segments_com_Shank_Right_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Shank_Right,freq,fs_filter_vel_acc);
[segments_com_Shank_Right_velocity.z,segments_com_Shank_Right_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Shank_Right,freq,fs_filter_vel_acc);


[segments_com_Foot_Left_velocity.x,segments_com_Foot_Left_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Foot_Left,freq,fs_filter_vel_acc);
[segments_com_Foot_Left_velocity.y,segments_com_Foot_Left_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Foot_Left,freq,fs_filter_vel_acc);
[segments_com_Foot_Left_velocity.z,segments_com_Foot_Left_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Foot_Left,freq,fs_filter_vel_acc);


[segments_com_Foot_Right_velocity.x,segments_com_Foot_Right_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_Foot_Right,freq,fs_filter_vel_acc);
[segments_com_Foot_Right_velocity.y,segments_com_Foot_Right_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_Foot_Right,freq,fs_filter_vel_acc);
[segments_com_Foot_Right_velocity.z,segments_com_Foot_Right_acceleration.z] = Get_Com_Velocity_Acceleration_New(zcom_Foot_Right,freq,fs_filter_vel_acc);
%% 求解总体质心位置
xcom_human = xcom_HeadNeck*M.HeadNeck + xcom_Trunk*M.Trunk + xcom_Pelvis*M.Pelvis + xcom_Upperarm_Left*M.Upperarm + xcom_Upperarm_Right*M.Upperarm + xcom_Forearm_Left*M.Forearm + xcom_Forearm_Right*M.Forearm...
...
ycom_human = ycom_HeadNeck*M.HeadNeck + ycom_Trunk*M.Trunk + ycom_Pelvis*M.Pelvis + ycom_Upperarm_Left*M.Upperarm + ycom_Upperarm_Right*M.Upperarm + ycom_Forearm_Left*M.Forearm + ycom_Forearm_Right*M.Forearm...
...
zcom_human = zcom_HeadNeck*M.HeadNeck + zcom_Trunk*M.Trunk + zcom_Pelvis*M.Pelvis + zcom_Upperarm_Left*M.Upperarm + zcom_Upperarm_Right*M.Upperarm + zcom_Forearm_Left*M.Forearm + zcom_Forearm_Right*M.Forearm...
...
%% 总体重心速度,加速度
[segments_com_human_velocity.x,segments_com_human_acceleration.x] = Get_Com_Velocity_Acceleration_New(xcom_human,freq,fs_filter_vel_acc);
[segments_com_human_velocity.y,segments_com_human_acceleration.y] = Get_Com_Velocity_Acceleration_New(ycom_human,freq,fs_filter_vel_acc);
[segments_com_human_velocity.z,segments_com_human_acceleration.z,vcom_z_raw,accom_z_raw] = Get_Com_Velocity_Acceleration_New(zcom_human,freq,fs_filter_vel_acc);
...
if false
    ...
    plot(vcom_z_raw);
    plot(segments_com_human_velocity.z);
    hold off; legend('raw','filter'); title('Vel of zcom');
    subplot(2,1,2); hold on;
    plot(accom_z_raw);
    plot(segments_com_human_acceleration.z);
    hold off; legend('raw','filter'); title('Acc of zcom');
    sgtitle(['滤波截止频率',num2str(fs_filter_vel_acc),'Hz']);
end
...
segments_com_position.Pelvis.x = xcom_Pelvis;
segments_com_position.Pelvis.y = ycom_Pelvis;
segments_com_position.Pelvis.z = zcom_Pelvis;
...
segments_com_velocity.Pelvis = segments_com_Pelvis_velocity;
...
segments_com_acceleration.Pelvis = segments_com_Pelvis_acceleration;
...
x_zero = segments_com_acceleration.human.x - (segments_com_acceleration.HeadNeck.x*M.HeadNeck + segments_com_acceleration.Trunk.x*M.Trunk + segments_com_acceleration.Upperarm_Left.x*M.Upperarm + segments_com_acceleration.Upperarm_Right.x*M.Upperarm + segments_com_acceleration.Forearm_Left.x*M.Forearm + segments_com_acceleration.Forearm_Right.x*M.Forearm...
    ...
    + segments_com_acceleration.Foot_Left.x*M.Foot + segments_com_acceleration.Foot_Right.x*M.Foot + segments_com_acceleration.Pelvis.x*M.Pelvis);
...
y_zero = segments_com_acceleration.human.y - (segments_com_acceleration.HeadNeck.y*M.HeadNeck + segments_com_acceleration.Trunk.y*M.Trunk + segments_com_acceleration.Upperarm_Left.y*M.Upperarm + segments_com_acceleration.Upperarm_Right.y*M.Upperarm + segments_com_acceleration.Forearm_Left.y*M.Forearm + segments_com_acceleration.Forearm_Right.y*M.Forearm...
    ...
    + segments_com_acceleration.Foot_Left.y*M.Foot + segments_com_acceleration.Foot_Right.y*M.Foot + segments_com_acceleration.Pelvis.y*M.Pelvis);
...
z_zero = segments_com_acceleration.human.z - (segments_com_acceleration.HeadNeck.z*M.HeadNeck + segments_com_acceleration.Trunk.z*M.Trunk + segments_com_acceleration.Upperarm_Left.z*M.Upperarm + segments_com_acceleration.Upperarm_Right.z*M.Upperarm + segments_com_acceleration.Forearm_Left.z*M.Forearm + segments_com_acceleration.Forearm_Right.z*M.Forearm...
    ...
    + segments_com_acceleration.Foot_Left.z*M.Foot + segments_com_acceleration.Foot_Right.z*M.Foot + segments_com_acceleration.Pelvis.z*M.Pelvis);
