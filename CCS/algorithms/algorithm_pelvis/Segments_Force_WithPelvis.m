function seg_force = Segments_Force_WithPelvis(mass,sex,ground_force_Left,ground_force_Right,hip_force_Left,hip_force_Right,segments_com_acceleration)
...
% 左大腿与骨盆作用力与反作用力
reaction_force_Pelvis_Lower_Left.x = -reaction_force_Thigh_Left_proximal.x;
reaction_force_Pelvis_Lower_Left.y = -reaction_force_Thigh_Left_proximal.y;
reaction_force_Pelvis_Lower_Left.z = -reaction_force_Thigh_Left_proximal.z;
...
% 右大腿与骨盆作用力与反作用力
reaction_force_Pelvis_Lower_Right.x = -reaction_force_Thigh_Right_proximal.x;
reaction_force_Pelvis_Lower_Right.y = -reaction_force_Thigh_Right_proximal.y;
reaction_force_Pelvis_Lower_Right.z = -reaction_force_Thigh_Right_proximal.z;
...
reaction_force_Pelvis_Upper.x = mass*M.Pelvis* segments_com_acceleration.Pelvis.x - reaction_force_Pelvis_Lower_Left.x - reaction_force_Pelvis_Lower_Right.x;
reaction_force_Pelvis_Upper.y = mass*M.Pelvis* segments_com_acceleration.Pelvis.y - reaction_force_Pelvis_Lower_Left.y - reaction_force_Pelvis_Lower_Right.y;
reaction_force_Pelvis_Upper.z = mass*M.Pelvis* segments_com_acceleration.Pelvis.z - reaction_force_Pelvis_Lower_Left.z - reaction_force_Pelvis_Lower_Right.z + mass*M.Pelvis*9.8;
% 作用力与反作用力
reaction_force_Trunk_Lower_proximal.x = -reaction_force_Pelvis_Upper.x;
reaction_force_Trunk_Lower_proximal.y = -reaction_force_Pelvis_Upper.y;
reaction_force_Trunk_Lower_proximal.z = -reaction_force_Pelvis_Upper.z;

%% 验证
force_zero_x = reaction_force_Trunk_Lower_proximal.x + ...
...
force_zero_y = reaction_force_Trunk_Lower_proximal.y + ...
...
force_zero_z = reaction_force_Trunk_Lower_proximal.z + ...
...
seg_force.reaction_force_Pelvis_Lower_Left = reaction_force_Pelvis_Lower_Left;
...
seg_force.reaction_force_Pelvis_Lower_Right = reaction_force_Pelvis_Lower_Right;
...
% 骨盆
seg_force.reaction_force_Pelvis_Upper = reaction_force_Pelvis_Upper;
seg_force.reaction_force_Trunk_Lower_proximal = reaction_force_Trunk_Lower_proximal;