function [Mas_stream,Sub_stream,T] = Read_Kinect_Azure_Cplus(filename)
...
c0 = textscan(fileID, '%s %{yyyy-MM-dd HH:mm:ss:SSS}D %64d %d %d   %[^\n]', 'delimiter', ',');
L = length(c0{1, 1}) -1;
fclose(fileID);
c = cell(1,6);
c{1} = c0{1}(1:L,1);
...
temp1 = textscan(c1{1}{1}, '%f %f %f %f', 'delimiter', '[,');
T(1,1) = temp1{2};T(1,2) = temp1{3};T(1,3) = temp1{4};T(1,4) = temp1{1}(2)/1000;
temp1 = textscan(c1{1}{2}, '%f %f %f %f', 'delimiter', ',');
T(2,1) = temp1{1};T(2,2) = temp1{2};T(2,3) = temp1{3};T(2,4) = temp1{4}/1000;
temp1 = textscan(c1{1}{3}, '%f %f %f %f', 'delimiter', ',');
T(3,1) = temp1{1};T(3,2) = temp1{2};T(3,3) = temp1{3};T(3,4) = temp1{4}/1000;
temp1 = textscan(c1{1}{4}, '%f %f %f %f', 'delimiter', ',');
T(4,1) = temp1{1};T(4,2) = temp1{2};T(4,3) = temp1{3};T(4,4) = temp1{4};
fclose(fileID2);
%% Mas 与sub 分开,
for i = 1:L
