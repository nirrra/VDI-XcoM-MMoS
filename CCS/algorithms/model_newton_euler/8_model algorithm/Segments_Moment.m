...
function [moment_reaction_couple_global_new,moment_reaction_couple_local_new,Segments_Length,moment_couple_global_new,moment_from_reaction_force_new] = Segments_Moment(mass,sex,kinectstream,...
...
for i=1:len_Alfa
    ...
    %% 躯干
    %各段力偶矩
    moment_reaction_couple_local.Trunk_Lower_Left_proximal{i} = (r_all_segments.Trunk{i})' * moment_reaction_couple_global.Trunk_Lower_Left_proximal{i};
    moment_reaction_couple_local.Trunk_Lower_Right_proximal{i} = (r_all_segments.Trunk{i})' * moment_reaction_couple_global.Trunk_Lower_Right_proximal{i};
