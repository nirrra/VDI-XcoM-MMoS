%% 计算地面力偶矩，基于传感器阵列对踝关节的力矩
function [ground_couple_moment_global_Left,ground_couple_moment_global_Right,moment_couple_global_new,...
    moment_com_global_new,moment_gravity_global_human_new] = Ground_Moment_Pressure2D(mass,sex,kinectstream,...
    segments_com_position,segments_com_acceleration,hip_force_Left,hip_force_Right,...
    plantarForceMomentLeft,plantarForceMomentRight,r_all_segments,segments_W_L,segments_Alpha_L)
%% 各体段测量参数
if sex == 'M'
    Lcs.HeadNeck = 1;
    Lcs.Trunk = 0.4486; 
...
for i=1:len_Alfa    
    ...
    % 地面反力偶矩,有坐垫参与
%     ground_couple_moment_global{i} = moment_couple_and_com_global.human{i}...
%         -[plantarForceMomentLeft.x(i),plantarForceMomentLeft.y(i),plantarForceMomentLeft.z(i)]...
%         -[plantarForceMomentRight.x(i),plantarForceMomentRight.y(i),plantarForceMomentRight.z(i)]...
...
%         [hip_force_Left.x(i),hip_force_Left.y(i),hip_force_Left.z(i)])';
    ...
    ground_couple_moment_global = moment_couple_and_com_global.human{i} - moment_gravity_global_human{i}...
        ...
        -cross([kinectstream.HIP_LEFT.x(i)+0.05,kinectstream.HIP_LEFT.y(i),kinectstream.HIP_LEFT.z(i)-0.1],...
        [hip_force_Left.x(i),hip_force_Left.y(i),hip_force_Left.z(i)])';
    aux = 0.5*ground_couple_moment_global-k*[plantarForceMomentLeft.x(i),plantarForceMomentLeft.y(i),plantarForceMomentLeft.z(i)]...
        -(1-k)*[plantarForceMomentRight.x(i),plantarForceMomentRight.y(i),plantarForceMomentRight.z(i)];
    ...
    aux = 0.5*ground_couple_moment_global-(1-k)*[plantarForceMomentLeft.x(i),plantarForceMomentLeft.y(i),plantarForceMomentLeft.z(i)]...
        -k*[plantarForceMomentRight.x(i),plantarForceMomentRight.y(i),plantarForceMomentRight.z(i)];
