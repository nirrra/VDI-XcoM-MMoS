function [] = DrawKinectFrame_WithMuscles(stream,idxFrame,muscles,segments_RM,segments_origin,segments_length,muscle_names,flagNewFigure)
if nargin<8, flagNewFigure = true; end
...
Spine{1} = jointArrayCell{idxFrame}.joints(20,:);
Spine{2} = jointArrayCell{idxFrame}.joints(21,:);
...
p1= plot3([HeadNeck{1}(1),HeadNeck{2}(1)],[HeadNeck{1}(2),HeadNeck{2}(2)],[HeadNeck{1}(3),HeadNeck{2}(3)],'.',...
    ...
    [SpB_HipL{1}(1),SpB_HipL{2}(1)],[SpB_HipL{1}(2),SpB_HipL{2}(2)],[SpB_HipL{1}(3),SpB_HipL{2}(3)],'.',...
    [SpB_HipR{1}(1),SpB_HipR{2}(1)],[SpB_HipR{1}(2),SpB_HipR{2}(2)],[SpB_HipR{1}(3),SpB_HipR{2}(3)],'.',...
    [Spine{1}(1),Spine{2}(1)],[Spine{1}(2),Spine{2}(2)],[Spine{1}(3),Spine{2}(3)],'.');
%设置线条属性
MS = 15;
...
p1(19).MarkerSize=MS;%右髋到脊椎底部
p1(19).Color=color3{1};
