function FigureMeanAndStd_Chinese(cellSegs, str_paras, colors, fig_options)
...
if plot_bw
    ...
    legend(legend_handles, legend_names, 'Location','southoutside', ...
        'FontSize', 16, 'Interpreter', 'latex', 'Orientation', 'horizontal', 'Box', 'on', 'FontName', 'SimHei');
else
    % 彩色模式：使用原图例
...
if with_title
    if has_chinese_title
        title(figure_name, 'FontSize', 16, 'FontWeight', 'bold', 'Interpreter', 'none', 'FontName', 'SimHei');
    else
