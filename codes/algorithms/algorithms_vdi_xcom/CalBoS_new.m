...
% Compute BoS (more general / smoother)
% img: 32x32 pressure image
% point_th_ratio: single-point threshold ratio
% erode_size: erosion kernel size (square)
% upsample_factor: upsampling factor (e.g., 4 -> 128x128)
